...
//	public void DyanamicWindowshandle(String expectedTitle)
//	{
//		
//		Set<String> windowsIds  =driver.getWindowHandles();
//		Iterator<String> windowsIdsList = windowsIds.iterator();
//		int windowsCount = windowsIds.size();
//		for(int i =0; i<windowsCount; i++)
//		{
//			System.out.println("ivalue :" +i);
//			currentWindowId = driver.getWindowHandle();
//			System.out.println("currentWindowId : "+ currentWindowId);
//			driver.switchTo().window(windowsIdsList.next());
...
//	}
	...
	public void ParentWindowHandles()
	{
		Set<String> windowsIds  =driver.getWindowHandles();
		Iterator<String> windowsIdsList = windowsIds.iterator();
		String parentWindowId = windowsIdsList.next(); //parent call
		String childWindowIds = windowsIdsList.next(); //child call
		driver.switchTo().window(parentWindowId);
	}
	...
	public void alertclick(WebElement element)
	{
		...
		elementFind(element).click();
		logger.info("alert popwindow ended started New account");
	}
...
//		}
	...
	public String verify(WebElement element, String data) throws Exception {
		...
		if (elementText.equals(data)) {
			System.out.println("Webpage data matching with expected data");
		} else {
...
//	}
	...
	public void clearAndTabout(WebElement element) {
		highlightElement(element);
		 WebElement element1 = elementFind(element);
		element1.clear();
