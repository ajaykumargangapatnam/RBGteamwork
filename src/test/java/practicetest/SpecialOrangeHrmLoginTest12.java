...
public class SpecialOrangeHrmLoginTest12 extends BaseTest
{
	SpecialOrangeHrmLoginPage12 s1;
	PropertySingleton _instance = null;
	SoftAssert s_assert = new SoftAssert();
	public void SpecialOrangeHrmLoginPage12() throws Throwable
	{
		_instance = PropertySingleton.getInstance();
		s1 = new SpecialOrangeHrmLoginPage12(GenericKeywordsWithPage.driver);
	}
	@BeforeClass
