...
public class SpecialOrangeHrmLoginTest15 extends BaseTest
{
	SpecialOrangeHrmLoginPage15 s1;
	PropertySingleton _instance = null;
	SoftAssert s_assert = new SoftAssert();
	public void SpecialOrangeHrmLoginPage15() throws Throwable
	{
		_instance = PropertySingleton.getInstance();
		s1 = new SpecialOrangeHrmLoginPage15(GenericKeywordsWithPage.driver);
	}
	@BeforeClass
