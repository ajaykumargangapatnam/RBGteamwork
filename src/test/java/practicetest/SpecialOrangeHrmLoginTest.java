...
public class SpecialOrangeHrmLoginTest extends BaseTest
	{
		SpecialOrangeHrmLoginPage s1;
		PropertySingleton _instance = null;
		SoftAssert s_assert = new SoftAssert();
		public void SpecialOrangeHrmLoginPage() throws Throwable
		{
			_instance = PropertySingleton.getInstance();
			s1 = new SpecialOrangeHrmLoginPage(GenericKeywordsWithPage.driver);
		}
		@BeforeClass
		...
		public Object[][] setData1() 
		{
			...
			return ReadData.getData("SpecialOrangeHrm", "OrangeHRM_TESTCASES", xls);	
		}
	}
