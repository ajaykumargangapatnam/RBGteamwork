...
public class SpecialOrangeHrmLoginTest3 extends BaseTest
{
	SpecialOrangeHrmLoginPage3 s1;
	PropertySingleton _instance = null;
	SoftAssert s_assert = new SoftAssert();
	public void SpecialOrangeHrmLoginPage3() throws Throwable
	{
		_instance = PropertySingleton.getInstance();
		s1 = new SpecialOrangeHrmLoginPage3(GenericKeywordsWithPage.driver);
	}
	@BeforeClass
