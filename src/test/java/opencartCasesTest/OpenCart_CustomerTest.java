...
public class OpenCart_CustomerTest extends BaseTest
{
	...
	public void UserClickonCustomers(Hashtable<String, String>h1) throws Throwable
	{
		...
		Thread.sleep(3000);
		op.clickon_Store();
		passLog("user clicked on Store");
		Thread.sleep(3000);
		op.clickon_CustomerStore();
		passLog("user clicked on CustomerStore");
		Thread.sleep(3000);
		...
		Thread.sleep(3000);
		op.enter_CustomerEmail(h1.get("email"));
		passLog("user Entered on Email");
		Thread.sleep(3000);
		op.enter_Telephone(h1.get("Telephone"));
		passLog("user Entered on Telephone");
		Thread.sleep(3000);
